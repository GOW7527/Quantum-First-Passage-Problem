...
class return_problem:
    def __init__(self, hamiltonian, psi_0, tau=None, N=1e4):
        ...
        if ishermitian(hamiltonian) == False:
            ...
            )  # The Hamiltonian of the system must be Hermitian
        ...
        if (
            self.tridiagonal
        ):  # If the Hamiltonian is tridiagonal, we can use the faster exact diagonalization procedure
